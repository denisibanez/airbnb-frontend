...
const SvgIconsTwoToneDarkLocation = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="#fff"
      fillRule="evenodd"
      d="M12 2.5 9 3 6 5 5 7.5v4l1 4 2.5 3L12 22l3-3 3-3.5 1.5-3.5V8.5L18 5l-2.5-2-2.5-.5zM12 13a3 3 0 1 0 0-6 3 3 0 0 0 0 6"
      clipRule="evenodd"
      opacity={0.2}
    />
    <path
...
export default SvgIconsTwoToneDarkLocation;
